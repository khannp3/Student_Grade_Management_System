...
//=========Question 1==================================
	...
	void TestQ1_first_empty_Pragya(CuTest *tc) {

		CuAssertStrEquals(tc, "Pragya!", my_strcat("","Pragya!"));
	}
...
//=================Question 2================================
	...
	void TestQ2_find_notThere_new(CuTest *tc) {
		...
		int expected = -1;
		int actual = find(00001111,Clist,size);
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ1_first_empty_Pragya);
		...
		SUITE_ADD_TEST(suite, TestQ2_find_notThere_new);
